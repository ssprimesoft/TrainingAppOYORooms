...
public class InviteAndEarnFragmentViewModel extends BaseObservable implements View.OnClickListener {

    private final InviteAndEarnFragment fragment;
    private final FragmentInviteAndEarnBinding mBinding;

    public InviteAndEarnFragmentViewModel(InviteAndEarnFragment fragment, FragmentInviteAndEarnBinding mBinding) {
